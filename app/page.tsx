	...
	return (
		<section className="flex flex-col items-center justify-center gap-4">
			<div className="relative flex w-full h-full min-h-[100dvh] justify-center items-center overflow-hidden">
				...
				<div className="absolute w-full h-[62vh] rounded-t-[112px] dark:h-[40vh] dark:rounded-b-[112px] dark:rounded-t-none top-[44%] dark:top-16 md:dark:h-screen md:top-0 md:h-screen bg-lime-100 z-10 md:dark:rounded-full md:rounded-full md:dark:top-0 md:left-[40%] dark:bg-green-950 md:dark:-left-[50%] transition-[color_left] ease-in-out duration-700"></div>
			</div>
